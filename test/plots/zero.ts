...
test(async function zeroDomainExplicit() {
  return Plot.plot({
...
test(async function zeroDomainExplicitNoZero() {
  return Plot.plot({
...
test(async function zeroDomainImplicit() {
  return Plot.plot({
...
test(async function zeroDomainDisabled() {
  return Plot.plot({
