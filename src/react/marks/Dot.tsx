...
export function Dot({
  ...
  const isRotateChannel = rotate != null && (typeof rotate === "string" || typeof rotate === "function" || Array.isArray(rotate));
  const isSymbolChannel = symbol != null && typeof symbol !== "object" && (typeof symbol === "string" && symbol !== "circle" && symbol !== "hexagon" || typeof symbol === "function" || Array.isArray(symbol));
  ...
  }), [x, y, r, rotate, symbol, fill, stroke, fillOpacity, strokeOpacity, opacity, title, href, isRChannel, isRotateChannel, isSymbolChannel]);
