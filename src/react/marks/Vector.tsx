...
export function Vector({
  ...
  const isLengthChannel = lengthProp != null && (typeof lengthProp === "string" || typeof lengthProp === "function" || Array.isArray(lengthProp));
  const isRotateChannel = rotateProp != null && (typeof rotateProp === "string" || typeof rotateProp === "function" || Array.isArray(rotateProp));
