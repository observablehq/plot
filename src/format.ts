...
const monthFormat = memoize1((locale: string | string[] | undefined, month: Intl.DateTimeFormatOptions["month"]) => new Intl.DateTimeFormat(locale, {timeZone: "UTC", month}));
const weekdayFormat = memoize1((locale: string | string[] | undefined, weekday: Intl.DateTimeFormatOptions["weekday"]) => new Intl.DateTimeFormat(locale, {timeZone: "UTC", weekday}));
...
export function formatMonth(locale = "en-US", month: Intl.DateTimeFormatOptions["month"] = "short") {
...
export function formatWeekday(locale = "en-US", weekday: Intl.DateTimeFormatOptions["weekday"] = "short") {
