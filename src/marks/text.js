...
import {indexOf, identity, string, maybeNumberChannel, maybeTuple, numberChannel, isNumeric, isTemporal, keyword, maybeFrameAnchor, isObjects} from "../options.js";
...
export class Text extends Mark {
  constructor(data, options = {}) {
    const {
      x,
      y,
      text = data != null && isObjects(data) ? indexOf : identity,
      textAnchor,
      lineAnchor = "middle",
      lineHeight = 1,
      fontFamily,
