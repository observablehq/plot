...
import {groupX, groupY} from "../transforms/group.js";
...
export function boxX(data, {
  ...
  return marks(
    ruleY(data, groupY({x1: iqr1, x2: iqr2}, {x, y, stroke, strokeOpacity, ...options})),
    barX(data, groupY({x1: "p25", x2: "p75"}, {x, y, fill, fillOpacity, ...options})),
    tickX(data, groupY({x: "p50"}, {x, y, stroke, strokeOpacity, strokeWidth, ...options})),
...
export function boxY(data, {
  ...
  return marks(
    ruleX(data, groupX({y1: iqr1, y2: iqr2}, {x, y, stroke, strokeOpacity, ...options})),
    barY(data, groupX({y1: "p25", y2: "p75"}, {x, y, fill, fillOpacity, ...options})),
    tickY(data, groupX({y: "p50"}, {x, y, stroke, strokeOpacity, strokeWidth, ...options})),
