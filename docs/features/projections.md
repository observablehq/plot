...
Projections apply to any point-based mark, but are most commonly used with the [geo mark](https://observablehq.com/@observablehq/plot-geo). Below, we create a [composite mark](https://github.com/observablehq/plot/blob/main/README.md#plotmarksmarks) consisting of three geos: a graticule showing lines of constant latitude and longitude, a set of polygons showing land area, and the outline of the sphere.
