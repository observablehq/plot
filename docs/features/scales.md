...
Continuous scales support an **interpolate** option, specified as a function function that takes a parameter *t* in [0, 1] and returns a value in the **range**, or as a two-argument function that takes a pair of values [*start*, *end*] from the range, and returns an interpolator from [0, 1], typically mapping 0 to *start*, and 1 to *end*.
