...
For linear and ordinal scales, if the data values are all integers between 1,000 and 3,000, Plot assumes they represent years and formats the scale’s ticks without thousands separators — for example, `2026` instead of `2,026`. This also applies to the [tip mark](../marks/tip.md).
