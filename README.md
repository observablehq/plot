...
* *planar* - a projection for planar geometry, with *y* pointing down 
* *reflect-y* - like the planar projection, but *y* points up
* *identity* (default) - the identity projection for pre-projected geometry in screen coordinates
