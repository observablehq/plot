...
The **r** option, if specified as a constant (in pixels) or a channel (typically bound to the *r* scale), defaults **width** and **height** to twice the effective radius, and clips the image to a circle, for rounded images. Set **clip** to null to omit clipping.
