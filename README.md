...
Quantitative scales, as well as *identity* for position scales, will coerce string values to numbers; time scales will likewise coerce string values to a date using [isoformat.parse](https://github.com/mbostock/isoformat/blob/main/README.md#parsedate-fallback), provided they are formatted as ISO 8601.
