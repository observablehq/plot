...
* *scale*.**tickFormat** - how to format tick values as a string (either a format specifier from [d3-format](https://github.com/d3/d3-format#locale_format) or [d3-time-format](https://github.com/d3/d3-time-format#locale_format), or a function — see also [Formats](#formats))
